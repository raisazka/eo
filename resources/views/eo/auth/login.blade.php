...
<html lang="en">
	...
	<div class="header-cover">
		...
		<div class="body-container">
            ...
            <form class="form-login" action="{{ route('eo.auth.loginEventOrganizer') }}" method="POST">
                @csrf
                <a href="#"><img class="left-arrow" src="{{asset('storage/images/left-arrow (3).png')}}"></a> 
					<h2 class="form-login-heading">EO Login</h2>
			...
			<h6 class="form-register">Belum punya akun?<a href="{{route('eo.register')}}"> Daftar sekarang</a></h6>
					<center><button class="btn btn-solid-light btn2" type="submit">Lanjutkan</button></center>
			<h6 class="form-join-partner">Punya inspirasi event? <a href="{{route('register')}}"> Join sebagai user</a></h6>
					</form>
			</div>
		</div>
	</div>
