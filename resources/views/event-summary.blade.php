...
<body>
    ...
    <div class="wrapper">
        <div class="sub-wrap">
            <div class="detailclass">
                ...
                <hr class="linee">
                    ...
                    <div class="venue">
                        ...
                        <div>
                        <h5>Nama Venue  :</h5>
                        <h3>{{$event->venue_id->name}}</h3>
                        <h5>Lokasi Venue  :</h5>
                        <h3>{{$event->venue_id->address}}</h3>
                        <h5>Harga Venue  :</h5>
                        <h3>Rp{{number_format($event->venue_id->price)}} / jam</h3>
                        <h5>Kapasitas Venue  :</h5>
                        <h3>{{$event->venue_id->seat_capacity}} orang</h3>
                        </div>
            ...
            <div class="apply-section">
                <h2>Ingin <b>Buat</b> ke Event Ini?</h2>
                <div class="apply-button">
                        <form style="display:inline-block;" action="{{route('event.store.summary')}}" method="POST">
                                @csrf
    ...
    <script>
            function initMap() {
          var uluru = {lat: {{$event->venue_id->latitude}}, lng: {{$event->venue_id->longitude}}};
